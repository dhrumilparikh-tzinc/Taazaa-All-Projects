...
single Gemini call on the extracted markdown text. The full markdown is stored
as _chunk_text so the richer content gets embedded with gemini-embedding-2.
"""
...
{{
  ...
  "document_type": "report|contract|invoice|proposal|manual|other",
