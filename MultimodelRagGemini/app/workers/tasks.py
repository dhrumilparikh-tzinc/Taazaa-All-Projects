...
process_file
    ...
    All processing uses Gemini File API and Gemini text-embedding-004.
...
from app.models.db import (
    ...
    JobStatus,
    get_engine,
)  # JobStatus.partial added in 0002 migration
        ...
        with Session(get_engine()) as db:
            ...
            try:
                ...
                try:
                    ...
                    err_str = str(summarise_exc)
                    # Rate-limit errors must propagate so Celery retries the whole job.
                    if (
                        "429" in err_str
                    ...
                    update_job_state(
                        ...
                        error_message=f"Summarisation failed: {err_str[:300]}",
                    )
